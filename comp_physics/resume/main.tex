...
\section{Summary}
\cvitem{}{Computational physics researcher building distributed scientific software and using machine learning to accelerate calculations in first-principles materials research. Experience spans Python/C++, CUDA/ROCm, MPI/OpenMP, Linux-based HPC environments, Docker containers for packing applications across environments, and scientific ML.}
