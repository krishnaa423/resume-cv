...
\section{Summary}
\cvitem{}{Computational physics researcher building distributed scientific software and using machine learning to accelerate calculations for first-principles materials research. Experience spans Python/C++, CUDA/ROCm, MPI/OpenMP, Linux-based HPC environments, INCITE-supported supercomputing workflows on Frontier at OLCF and Perlmutter at LBNL, and Docker containers for packing applications across environments.}

\section{Research Experience}
\cventry{2021--present}{PhD Research Assistant}{Yale University, Electrical Engineering}{}{}{\begin{itemize}%
\item Built distributed simulation software in Python and C++ for INCITE-supported first-principles workloads on leadership-class HPC systems, using MPI, OpenMP, CUDA, ROCm, PETSc, and SLEPc on Frontier at OLCF, Perlmutter at LBNL, and related national-lab clusters.
