...
\section{Summary}
\cvitem{}{GPU-focused computational scientist and software engineer targeting performance-oriented systems and HPC infrastructure roles. Builds accelerator-enabled applications in Python and C++ with CUDA, ROCm, MPI, and OpenMP, with experience in multi-GPU parallelization, collective communication, distributed debugging, and strong and weak scaling analysis on national-lab supercomputers.}
...
\item Parallelized matrix and vector workloads across multiple GPUs, using collective communication and distributed linear-algebra workflows to scale simulations across accelerator-backed clusters.
\item Ported and optimized scientific-computing workloads for AMD MI250X and NVIDIA A100 GPU systems, translating many-body and excited-state physics methods into scalable accelerator-backed implementations.
...
\cvitem{Accelerator-Enabled Exciton-Phonon Simulation}{Developed distributed first-principles calculations with CUDA, ROCm, MPI, and OpenMP, including multi-GPU matrix and vector parallelization on leadership-class GPU clusters.}
